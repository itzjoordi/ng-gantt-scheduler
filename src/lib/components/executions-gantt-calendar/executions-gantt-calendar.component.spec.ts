...
import { ExecutionsGanttCalendarComponent } from './executions-gantt-calendar.component';

describe('ExecutionsGanttCalendarComponent', () => {
  let component: ExecutionsGanttCalendarComponent;
  let fixture: ComponentFixture<ExecutionsGanttCalendarComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ExecutionsGanttCalendarComponent],
      schemas: [CUSTOM_ELEMENTS_SCHEMA, NO_ERRORS_SCHEMA]
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(ExecutionsGanttCalendarComponent);
  ...
  it('should inilizate ngOnInit when ngOnChanges', () => {
    component.calendar = {
      year: { display: false, widths: [] },
      day: {
        display: true,
        widths: [
          { day: 11.123046875, month: 0 },
          { day: 5.5615234375, month: 0 },
          { day: 11.123046875, month: 0 },
          { day: 11.123046875, month: 0 },
          { day: 11.123046875, month: 0 },
          { day: 11.123046875, month: 0 },
      ...
      month: {
        display: false,
        widths: [
          { month: 11.123046875, day: 0 },
          { month: 5.5615234375, day: 0 },
          { month: 11.123046875, day: 0 },
          { month: 5.5615234375, day: 0 },
          { month: 5.5615234375, day: 0 },
          { month: 5.5615234375, day: 0 },
  ...
  it('should inilizate ngOnInit view month', () => {
    component.calendar = {
      year: { display: false, widths: [] },
      day: {
        display: true,
  ...
  it('should toBeTruthy when nounthsCount === 0', () => {
    component.calendar = {
      day: {
        display: true,
        widths: [
    ...
    component.times = {
      ...
      lastTaskTime: 1671145200000,
      firstTime: 1658527200000,
      lastTime: 1648527200000,
      steps: [{ time: 1658527200000, showLine: true, offset: { ms: 0, px: 0 }, width: { ms: 86400000, px: 48 } }]
    };
    fixture.detectChanges();
    component.ngOnInit();
    expect(component).toBeTruthy();
  ...
  it('should howManyDaysFit return 0 if not additionalSpace * days <= fullWidth && days > 1', () => {
    component.calendar = {
      day: {
        display: true,
        widths: [
