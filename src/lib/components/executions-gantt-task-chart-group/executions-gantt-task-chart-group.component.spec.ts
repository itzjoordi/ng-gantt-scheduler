...
import { OptionsActionsInterface } from '@pages/executions/interfaces/options-actions.interface';
import { OptionsTimesInterface } from '@pages/executions/interfaces/options-times.interface';
...
import { ExecutionsGanttTaskChartGroupComponent } from './executions-gantt-task-chart-group.component';

const timesMock: OptionsTimesInterface = {
  width: 8648,
  ...
  steps: [
    ...
    { time: 1658613600000, showLine: false, offset: { ms: 86400000, px: 48 }, width: { ms: 86400000, px: 49 } },
...
const taskMock: ExecutionTaskGanttInterface = {
  id: '3',
  internalId: '4432',
  label: 'Ricardo Perís',
  startTime: 1641859200000,
  endTime: 1665846777000,
  offsetPre: 3,
  offsetPost: 4,
  type: { id: 'group', typeName: '' },
  asignedTo: null,
  typeModel: '',
  ...
  childs: [
    ...
    },
    {
      id: '14432',
      internalId: '4432',
      label: '2 Teatinos (Málaga)',
      startTime: 1663081977000,
      endTime: 1664464377000,
      offsetPre: 3,
      offsetPost: 4,
      type: { id: '2', typeName: 'Aperturas-Reformas' },
      asignedTo: null,
    ...
    },
    {
      id: '24432',
      internalId: '4432',
      label: '3 Teatinos (Málaga)',
      startTime: 1664723577000,
      endTime: 1665846777000,
      offsetPre: 3,
      offsetPost: 4,
      type: { id: '2', typeName: 'Aperturas-Reformas' },
    ...
    },
    {
      ...
      label: '3 Teatinos (Málaga)',
      startTime: 1664723577000,
      endTime: 1667948400000,
      offsetPre: 1,
      offsetPost: 1,
      type: { id: '1', typeName: 'Actuaciones' },
      asignedTo: null,
      typeModel: 'MASTER',
      center: { publicId: '2064', zoneId: 1 },
      collapsed: false,
...
const taskMockChildNotCollapsed: ExecutionTaskGanttInterface = {
  id: '4432',
  internalId: '4432',
  label: 'Teatinos (Málaga)',
...
const options: OptionsActionsInterface = { update: false, delete: false, restore: false, isHistorical: false };

describe('ExecutionsGanttTaskChartGroupComponent', () => {
  let component: ExecutionsGanttTaskChartGroupComponent;
  let fixture: ComponentFixture<ExecutionsGanttTaskChartGroupComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ExecutionsGanttTaskChartGroupComponent, ExecutionsGanttTaskChartRowComponent],
      schemas: [CUSTOM_ELEMENTS_SCHEMA, NO_ERRORS_SCHEMA]
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(ExecutionsGanttTaskChartGroupComponent);
    component = fixture.componentInstance;
    fixture.detectChanges();
  });

  it('should create', () => {
    component.times = timesMock;
  ...
  it('should return 60 height if have one child and collapsed', () => {
    component.times = timesMock;
    component.task = taskMockChildNotCollapsed;
    component.options = options;
    fixture.detectChanges();
    expect(component.height).toEqual(60);
  });

  it('should return 60 height', () => {
    component.times = timesMock;
    component.task = taskMockChildNotCollapsed;
    component.options = options;
    expect(component.height).toEqual(60);
